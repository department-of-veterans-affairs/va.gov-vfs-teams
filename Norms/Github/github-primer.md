...
[Visit this page](https://github.com/department-of-veterans-affairs/vets-external-teams) to see the UI features below:
...
[Visit this page](https://github.com/department-of-veterans-affairs/vets-external-teams/tree/master/Onboarding) to see the UI features below:
...
1. Navigate to ```https://github.com/department-of-veterans-affairs/vets-external-teams/blob/master/Norms/Github/sample-edit-file.md```
1. Select the file.
